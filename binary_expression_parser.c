...
static const struct op_entry ops[] = {
    ...
    { TOKEN_KIND_LESS_EQUAL_PUNCTUATOR,    0,   BINARY_OPERATION_LESS_THAN_OR_EQUAL,     BINARY_EXPRESSION_PRECEDENCE_RELATIONAL,     AST_NODE_KIND_BINARY_EXPRESSION, WARNING_SIGN_COMPARE },
    { TOKEN_KIND_GREATER_EQUAL_PUNCTUATOR, 0,   BINARY_OPERATION_GREATER_THAN_OR_EQUAL,  BINARY_EXPRESSION_PRECEDENCE_RELATIONAL,     AST_NODE_KIND_BINARY_EXPRESSION, WARNING_SIGN_COMPARE },
